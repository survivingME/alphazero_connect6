...
#            self.state = tf.transpose(self.state_input, [0, 2, 3, 1])
        ...
        # conv layers
        conv1 = tf.layers.conv2d(self.state_input, filters=256, kernel_size=3,
                         strides=1, padding="SAME", data_format='channels_first',
                         activation=tf.nn.relu, name="conv1")
        conv2 = tf.layers.conv2d(conv1, filters=256, kernel_size=3,
                         strides=1, padding="SAME", data_format='channels_first',
        ...
        conv8 = tf.layers.conv2d(conv7, filters=256, kernel_size=3,
                                 strides=1, padding="SAME", data_format='channels_first',
                                 activation=tf.nn.relu, name="conv8")
        conv9 = tf.layers.conv2d(conv8, filters=256, kernel_size=3,
                                 strides=1, padding="SAME", data_format='channels_first',
                                 activation=tf.nn.relu, name="conv9")
        conv10 = tf.layers.conv2d(conv9, filters=256, kernel_size=3,
                                 strides=1, padding="SAME", data_format='channels_first',
                                 activation=tf.nn.relu, name="conv10")
        conv11 = tf.layers.conv2d(conv10, filters=256, kernel_size=3,
                                 strides=1, padding="SAME", data_format='channels_first',
                                 activation=tf.nn.relu, name="conv11")
        conv12 = tf.layers.conv2d(conv11, filters=256, kernel_size=3,
                                 strides=1, padding="SAME", data_format='channels_first',
                                 activation=tf.nn.relu, name="conv12")
        conv13 = tf.layers.conv2d(conv12, filters=256, kernel_size=3,
                                 strides=1, padding="SAME", data_format='channels_first',
                                 activation=tf.nn.relu, name="conv13")
        conv14 = tf.layers.conv2d(conv13, filters=256, kernel_size=3,
                                 strides=1, padding="SAME", data_format='channels_first',
                                 activation=tf.nn.relu, name="conv14")
        conv15 = tf.layers.conv2d(conv14, filters=256, kernel_size=3,
                                 strides=1, padding="SAME", data_format='channels_first',
                                 activation=tf.nn.relu, name="conv15")
        # action policy layers
        policy_net = tf.layers.conv2d(conv15, filters=4, kernel_size=1,
                         strides=1, padding="SAME", data_format='channels_first',
        ...
        # state value layers
        value_net = tf.layers.conv2d(conv15, filters=2, kernel_size=1, data_format='channels_first',
                                     name='value_conv', activation=tf.nn.relu)
        value_net = tf.layers.dense(tf.contrib.layers.flatten(value_net), 256, activation=tf.nn.relu)
